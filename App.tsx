        ...
        <div className="flex items-center gap-10">
            ...
            <div className="hidden md:flex items-center gap-8">
              ...
              <div className="w-10 h-10 rounded-full border border-white/20 bg-white/5 flex items-center justify-center relative">
                ...
                <button 
                  ...
                  className="absolute -bottom-1 -right-1 w-5 h-5 bg-white text-black rounded-full flex items-center justify-center border-2 border-[#050505] hover:bg-rose-500 hover:text-white transition-colors"
                  title="Cerrar Sesión"
                >
                  <LogOut size={10} />
                </button>
          ...
          {!user && (
            <button
              ...
              className="px-6 py-2 border border-white/10 rounded-lg text-[10px] uppercase tracking-[0.2em] font-semibold hover:bg-white hover:text-black transition-all"
            >
              Iniciar Sesión
            </button>
          )}
      ...
      <main className="flex-1 px-12 py-16 flex flex-col max-w-[1400px] mx-auto w-full">
        {!user ? (
          <div className="flex-1 flex flex-col items-center justify-center py-20">
            ...
            >
              <h2 className="serif text-6xl font-light tracking-tight mb-6 italic">Organiza tu código.</h2>
              <p className="text-white/40 max-w-lg mx-auto mb-12 font-light leading-relaxed">
                Un entorno simplificado para centralizar tus despliegues, herramientas y proyectos personales con la elegancia de un entorno premium.
              </p>
              <button
                onClick={handleSignIn}
                className="px-12 py-4 bg-white text-black rounded-full font-bold uppercase tracking-widest text-xs hover:scale-105 active:scale-95 transition-all shadow-2xl hover:shadow-white/10"
              >
                Acceder con Google
              </button>
            </motion.div>
