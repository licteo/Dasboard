...
export default function App() {
  ...
  if (error) {
    return (
      <div className="min-h-screen bg-[#050505] text-[#EAEAEA] flex flex-col items-center justify-center p-6 text-center">
        <h2 className="serif text-4xl italic mb-4">Algo salió mal</h2>
        <p className="text-white/40 max-w-md leading-relaxed mb-8">{error}</p>
        <button 
          onClick={() => window.location.reload()}
          className="px-8 py-3 bg-white text-black rounded-full font-bold uppercase tracking-widest text-[10px] hover:scale-105 transition-all"
        >
          Reintentar
        </button>
      </div>
        ...
        <div className="flex items-center gap-10">
          {showInstallBtn && (
            <button 
              ...
              className="flex items-center gap-2 px-4 py-2 bg-orange-500 text-black rounded-lg text-[10px] uppercase font-bold tracking-widest hover:bg-orange-400 transition-all"
            >
              <Download size={14} />
